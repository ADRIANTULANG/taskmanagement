...
class UpdateTaskView extends GetView<ProjectDetailController> {
  const UpdateTaskView({super.key, required this.documentID});
  final String documentID;
  @override
  Widget build(BuildContext context) {
    return Obx(
      () => controller.isUpdatingTask.value == true
          ? Scaffold(
              body: Center(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (controller.deadline.value != '' &&
                          ...
                          controller.updateTaskDetails(documentID: documentID);
                        }
                      }),
                ),
              ),
