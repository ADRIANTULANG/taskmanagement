...
class ProjectDetailBottomSheet {
  ...
  static showrRemoveMembers(
      {required ProjectDetailController controller}) async {
    TextEditingController textfield = TextEditingController();
    Get.bottomSheet(Container(
        height: 60.h,
        width: 100.w,
              ...
              Expanded(
                child: Container(
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return Get.find<StorageServices>().storage.read('id') ==
                              controller.membersList[index].id
                          ? SizedBox()
                          : Padding(
                              padding: EdgeInsets.only(top: 1.h),
                              child: Row(
